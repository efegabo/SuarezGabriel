   ...
   <div  style="width: 100%;  ">     
    <div style="width: 100%; height:100%; margin: auto ; display:inline-block;" >
       <div style=" width:100%; height: 100%; top:0; font-size:20px; text-align:center; float:left; ">
        	<h1>¿Quién es Suarez Gabriel.?</h1>
       		 <hr>
             
          <div id="posteo" style="text-align: left; font-size:0.5vw;">
                Posteado por:  Suarez Gabriel<br>
                Fecha: 2023-05-02 <br>
          </div>
        </div>
    </div>
...
<p class="eys-parrafo"> El primer lenguaje con el cual empece a programar  en el colegio fue  <b><a href="https://es.wikipedia.org/wiki/C%2B%2B">C++</a></b> en sus laboratorios.</p>
   ...
   <div id="blog-seccion4"  style="height: 50px;"></div>
    ...
    <h2 style="border-bottom: 1px solid green;"> Mis Hooby</h2> 
                   ...
                   <p   class="eys-parrafo">Me gusta autoaprender, dibujar por mis ratos libres digital y tracionalmente    </p>
